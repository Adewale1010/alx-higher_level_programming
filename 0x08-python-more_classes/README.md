...
8. Compare rectangles
  ...
  8-rectangle.py: Python class Rectangle that defines a rectangle by: (based on 7-rectangle.py)
...
9. A square is a rectangle
  ...
  9-rectangle.py: Python class Rectangle that defines a rectangle by: (based on 8-rectangle.py)
